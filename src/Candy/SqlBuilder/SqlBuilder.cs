...
namespace Candy.SqlBuilder
{
    ...
    {
        protected ICandyDbExecute DbExecute { get; private set; }
        ...
        protected SqlBuilder(ICandyDbExecute dbExecute) => DbExecute = dbExecute;
        #endregion
        ...
        public TSQL By<TDbName>() where TDbName : struct, ICandyDbName
        {
            ...
            DbExecute.Dispose();
            DbExecute = _dbContext.GetExecute(DbName);
            return This;
        }
        ...
        public string ToString(string field)
        {
            ...
            return DbExecute.ConnectionOptions.TypeConverter.ConvertSqlToString(this);
        }
        /// <summary>
        /// 设置sql语句
        /// </summary>
